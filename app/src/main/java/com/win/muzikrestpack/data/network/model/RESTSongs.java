...
public class RESTSongs {
     ...
     * @param include
     */
    public RESTSongs(Integer page, Integer pageSize, Integer count, List<Object> include, Integer pageCount, Object previousPage, Integer nextPage, Object previousHref, String nextHref) {
        super();
        this.page = page;
